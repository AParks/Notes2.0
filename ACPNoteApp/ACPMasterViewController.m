...
- (void)insertNewObject:(double) lat lon:(double)lon title:(NSString *) title description:(NSString *) description
{
    ...
    [newManagedObject setValue:[NSNumber numberWithDouble:lat]  forKey:@"latitude"];
